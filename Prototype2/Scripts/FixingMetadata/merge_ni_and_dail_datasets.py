...
NI_PATH = data_path("NorthernIreland", "ni_metadata", "ni_segments_index_with_native.csv")
DAIL_PATH = data_path("DailData", "roi_MetaData", "dail_segments_index.csv")
OUT_PATH = metadata_path("all_segments_index.csv")
