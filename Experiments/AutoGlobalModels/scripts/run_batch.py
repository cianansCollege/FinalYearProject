"""
Runs the full global Common Voice accent experiment batch.
...
BASE_DIR = Path("/Users/cianan/Documents/College/GitHub/FYP/Experiments/AutoGlobalModels")
CSV_PATH = Path("/Users/cianan/Documents/College/GitHub/FYP/Data/CommonVoice/training_global_clean.csv")
...
def main() -> None:
        ...
        try:
            ...
            for model_name in MODELS.keys():
                failures.append({
                    "task_name": task_name,
                    "model_name": model_name,
                    "error": f"Task preparation failed: {exc}",
                })
            continue
    ...
    if all_results:
        ...
        summary_path = RESULTS_DIR / "global_model_summary.csv"
